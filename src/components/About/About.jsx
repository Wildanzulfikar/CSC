...
const About = () => {
  ...
  return (
    <div
      style={{ minHeight: "100vh", backgroundColor: "#003366", color: "white" }}
    >
      ...
      >
        <div style={{ textAlign: "center", width: "100%" }}>
          ...
          <div style={{ display: "flex", justifyContent: "center" }}>
            ...
            {/* Garis biru di bawah judul About Us */}
          </div>
          <div style={frameStyle}>
            <p style={{ marginBottom: "1rem", textAlign: "center" }}>
              Computer Student Club (CSC) adalah kelompok studi mahasiswa di
              Politeknik Negeri Jakarta yang berfokus pada minat mahasiswa dalam
        ...
        >
          ...
          >
            ...
            <div style={frameStyle}>
              <p style={{ marginBottom: "1rem", textAlign: "center" }}>
                Menjadi wadah pengembangan minat dan bakat mahasiswa dalam
                bidang teknologi yang berfokus pada kecerdasan buatan,
                pengembangan perangkat lunak, dan internet of things (IoT) yang
                menginspirasi dan mempengaruhi pengembangan masa depan dalam
                dunia teknologi.
              </p>
            </div>
          </div>
          ...
          >
            ...
            <div style={frameStyle}>
              <p style={{ marginBottom: "1rem", textAlign: "center" }}>
                Memberikan pemahaman teknologi, mendukung keahlian mahasiswa,
                menyediakan platform eksplorasi, mendorong kolaborasi,
                menginspirasi inovasi, mendukung prestasi, mempromosikan
                keamanan teknologi, serta etika.
              </p>
            </div>
          </div>
        </div>
